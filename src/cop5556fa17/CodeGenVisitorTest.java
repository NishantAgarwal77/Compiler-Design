...
public class CodeGenVisitorTest {
	...
	public void prog10() throws Exception {
		...
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;3;4;7;5;7;35;2;17;-10;-10;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void prog40() throws Exception {
		...
		show(input);
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"34", "56"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;0;34;1;56;5;7;false;56;56;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void prog41() throws Exception {
		...
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;73;6;79;2;77;78;2;76;2;74;true;true;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void prog42() throws Exception {
		...
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;73;6;79;2;77;78;2;76;2;74;false;false;true;true;false;true;true;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void prog43() throws Exception {
		...
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;73;6;79;2;77;78;2;76;2;74;false;false;true;true;false;false;false;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void unaryExpr2() throws Exception {
		...
		runCode(prog, bytecode, commandLineArgs);		
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;5;5;5;-5;-5;leaving main;",RuntimeLog.globalLog.toString());
	...
	public void unaryExpr3() throws Exception {
		...
		runCode(prog, bytecode, commandLineArgs);		
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;11111;11111;11111;2147472536;2147472536;leaving main;",RuntimeLog.globalLog.toString());
										
	}
	
	@Test
	public void unaryExpr6() throws Exception {
		String prog11 = "prog11";
		String input =  "prog11\nint v1;\nv1 = +-+-++------5;\n\nint v2;\nv2 = +-+-+++++++++++++++++3;\n\nint v3;\nv3 = v1 + v2 - 0;\nv3 -> SCREEN;";
		show(input);
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; 
		runCode(prog11, bytecode, commandLineArgs);		
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;11111;11111;11111;2147472536;2147472536;leaving main;",RuntimeLog.globalLog.toString());
